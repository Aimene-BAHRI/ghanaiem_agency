...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Premier",sLast:"Dernier",sNext:">",sPrevious:"<"},sEmptyTable:"Aucune donnée disponible",sInfo:"Afficher _START_ à _END_ de _TOTAL_ entrées",sInfoEmpty:"Afficher 0 à 0 de 0 entrées",sInfoFiltered:"(filtré à partir de _MAX_ entrées totales)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Afficher _MENU_ entrées",sLoadingRecords:"Chargement... ",sProcessing:"Traitement... ",sSearch:"Chercher:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun enregistrements correspondants trouvés"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
